...
namespace Future.EntityFrameworkCore.Seed.Host
{
    public class HostRoleAndUserCreator
    {
        ...
        public HostRoleAndUserCreator(FutureDbContext context)
        {
            _context = context;
        }
        ...
        private void CreateHostRoleAndUsers()
        {
            ...
            var permissions = PermissionFinder
                .GetAllPermissions(new FutureAuthorizationProvider())
            ...
            var adminUserForHost = _context.Users.IgnoreQueryFilters().FirstOrDefault(u => u.TenantId == null && u.UserName == MajidUserBase.AdminUserName);
            if (adminUserForHost == null)
            {
                var user = new User
                {
                    TenantId = null,
                    UserName = MajidUserBase.AdminUserName,
                    Name = "admin",
                    Surname = "admin",
