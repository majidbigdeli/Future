...
{
    [MajidAuthorize(PermissionNames.Pages_Tenants)]
    public class TenantAppService : AsyncCrudAppService<Tenant, TenantDto, int, PagedResultRequestDto, CreateTenantDto, TenantDto>, ITenantAppService
    {
        ...
        private readonly IMajidZeroDbMigrator _majidZeroDbMigrator;
        ...
        public TenantAppService(
            ...
            IMajidZeroDbMigrator majidZeroDbMigrator, 
            ...
            : base(repository)
        {
            ...
            _majidZeroDbMigrator = majidZeroDbMigrator;
        ...
        public override async Task<TenantDto> Create(CreateTenantDto input)
        {
            ...
            _majidZeroDbMigrator.CreateOrMigrateForTenant(tenant);
